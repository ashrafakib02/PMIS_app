        ...
        return (
            ...
            <View style={styles.container}>
              ...
              <View>
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', }}>
                    <Text style={[tw` mt-2.5  text-indigo-700`, styles.titleBox]}>Submitted By</Text>
                    <Text style={[tw`mt-2.5 ml-1.5  text-indigo-700`, styles.DataBox]}>{ncn_submitted_by}</Text>
                  </View>
                  <View style={{ flex: 1, flexDirection: 'row', }}>
                    <Text style={[tw` mt-2.5  text-indigo-700`, styles.titleBox]}>Date </Text>
                    <Text style={[tw`mt-2.5 ml-1.5  text-indigo-700`, styles.DataBox]}>{currentDate}</Text>
                  </View>
