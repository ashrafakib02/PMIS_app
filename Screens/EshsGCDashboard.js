...
export default function EshsGCDashboard() {
    const navigation = useNavigation();

    const eshs_dash = global.eshs_dash;
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white', padding: 5 }}>
            ...
            <View>
                <Text style={tw`my-5 ml-10 mt-5 font-bold`}>Welcome, {global.name} </Text>
            </View>
            <View>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={{ flex: 1 }}>
                            ...
                            <View style={[tw`pt-5 pl-5 pr-5 pb-5 ml-5 mr-5 mt-5 shadow-neutral-900 rounded-3xl bg-indigo-900`, styles.shadow]}>
                                ...
                                <View style={{ marginTop: 10, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ alignItems: 'flex-start', }}>
                                        <Text style={styles.box_text}>Corrective Action Not Taken:</Text>
                                    </View>
                                ...
                                <View style={{ marginTop: 10, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ alignItems: 'flex-start', }}>
                                        <Text style={styles.box_text}>Corrective Action Accepted:</Text>
                                    </View>
                                ...
                                <View style={{ flexDirection: 'row', marginTop: 10, }}>
                                    ...
                                    <View style={{ flex: 1, alignItems: 'flex-start', }}>
                                        <Text style={styles.box_text}>Corrective Action Not Accepted:</Text>
                                    </View>
                                ...
                                <View style={{ marginTop: 10, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ alignItems: 'flex-start', }}>
                                        <Text style={styles.box_text}>Accidents in last Month</Text>
                                    </View>

                                    <View style={{ flex: 1, alignItems: 'flex-end', }}>
                                        <Text style={styles.box_text}>{item.accident}</Text>
                                    </View>
                            ...
                            <View>
                                <TouchableOpacity
                                    onPress={() => navigation.navigate('ESHSObservationForm')}
                                    style={{
                                        alignItems: 'center',
                                    ...
                                    <Text style={{ fontWeight: 'bold',color:'white',}}>Submit Observation</Text>
                                </TouchableOpacity>

                                <TouchableOpacity
                                    onPress={() => navigation.navigate('ESHSGCObserveList', {
                            ...
                            <View>
                                <TouchableOpacity
                                    onPress={() => navigation.navigate('NcrForm')}
                                    style={{
                                        alignItems: 'center',
                                        justifyContent: 'center',
                                        borderWidth: 2,
                                    ...
                                    <Text style={{ fontWeight: 'bold',color:'white',}}>Submit NCR</Text>
                                </TouchableOpacity>
                            ...
                            <View>
                                <TouchableOpacity
                                    ...
                                    <Text style={{ fontWeight: 'bold',color:'white',}}>Submit Incident Report</Text>
                                </TouchableOpacity>
